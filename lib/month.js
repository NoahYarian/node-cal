...
module.exports = function(month, year, view) {
  ...
  var monthObj = {};
  monthObj.line1 = view === "year" ? getLine1(months[month-1]) : getLine1(months[month-1], year); // seems opposite but it's right. No year in the year view.
  ...
  function getLine1 (month, year, view) {
